...
## Optional Linux HTTP dependency

The OpenSynapse base package has no mandatory third-party Python runtime dependency.

Linux users who want the optional HTTP MCP transport install the http extra:
...
Android/Termux uses the dependency-free stdlib MCP stdio transport and does not require FastMCP, watchfiles, maturin, or Rust.
